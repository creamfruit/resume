document.addEventListener("DOMContentLoaded", function () {
  ...
  if (backBtn) backBtn.addEventListener("click", () => window.location.href = "/ryan/dashboard");
...
function showProfanityBlock(text) {
  ...
  async function apiListMatches() {
    const res = await fetch("/ryan/api/matches");
  ...
  async function apiListMessages(chatId) {
    const res = await fetch(`/ryan/api/messages/${encodeURIComponent(chatId)}`);
  ...
  async function apiReportProfanityBlock(chatId, text) {
    const res = await fetch("/ryan/api/profanity-block", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  async function apiListProfanities() {
    const res = await fetch("/ryan/api/profanities");
  ...
  async function apiGetSession() {
    const res = await fetch("/ryan/api/session");
  ...
  async function apiUpdateMessage(messageId, text) {
    const res = await fetch(`/ryan/api/messages/${messageId}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
  ...
  async function apiDeleteMessage(messageId) {
    const res = await fetch(`/ryan/api/messages/${messageId}`, { method: "DELETE" });
  ...
  async function apiRestoreMessage(messageId) {
    const res = await fetch(`/ryan/api/messages/${messageId}/restore`, { method: "POST" });
  ...
  async function sendMessage() {
    ...
    try {
      ...
      alert("Send failed. Check /ryan/api/messages/<chatId> in Flask.");
      console.error(e);
    }
  }
