document.addEventListener('DOMContentLoaded', () => {
  ...
  const localNotifBtn = document.getElementById('notif-btn');
  const localBadges = Array.from(document.querySelectorAll('.notification-badge'));
  ...
  if (localNotifBtn && notifPanel) localNotifBtn.addEventListener('click', () => toggle(notifPanel));
  ...
  function updateBadges() {
    ...
    localBadges.forEach((b) => { b.textContent = String(unread); });
  }
